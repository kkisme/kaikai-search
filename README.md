...
支持题干、选项、背景和备注搜索，多关键词共同匹配、全拼和首字母搜索；没有精确结果时尝试单字替换近似匹配。文字关键词高亮，右下角上下按钮依次定位；每次搜索或切换题型回到首条结果。拼音和近似匹配不伪造文字高亮。答案直接显示。页面将案例与综合合并为“案例题”，知识卡与案例资料合并为“知识卡”；使用紧凑题型标签，不展示原题号和章节来源。
