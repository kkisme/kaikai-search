const CACHE = 'kaikai-search-v4-20260907-app-download';
const ASSETS = ['./','./index.html','./app.css?v=20260907-auto-load','./app.js?v=20260907-auto-load','./search.js','./question-bank.json','./manifest.json','./icons/icon.svg','./icons/developer-logo.webp'];
