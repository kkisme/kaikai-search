const CACHE = 'kaikai-search-v4-20260907-home2';
const ASSETS = ['./','./index.html','./app.css?v=20260907-home2','./app.js?v=20260907-home2','./search.js','./question-bank.json','./manifest.json','./icons/icon.svg'];
