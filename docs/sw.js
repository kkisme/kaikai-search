const CACHE = 'kaikai-search-v4-20260907-case-order';
const ASSETS = ['./','./index.html','./app.css?v=20260907-bank-meta','./app.js?v=20260907-bank-date','./search.js','./question-bank.json','./manifest.json','./icons/icon.svg','./icons/developer-logo.webp'];
