const CACHE = 'kaikai-search-v4-20260907-install-guide';
const ASSETS = ['./','./index.html','./app.css?v=20260907-install-guide','./app.js?v=20260907-install-guide','./search.js','./question-bank.json','./manifest.json','./icons/icon.svg','./icons/developer-logo.webp'];
