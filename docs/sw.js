const CACHE = 'kaikai-search-v9-20260924-new-banks';
const ASSETS = ['./','./index.html','./app.css?v=20260907-black-nav','./app.js?v=20260924-new-banks','./search.js','./question-bank.json','./manifest.json','./icons/icon.svg','./icons/developer-logo.webp'];
