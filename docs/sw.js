const CACHE = 'kaikai-search-v4-20260907-autorefresh';
const ASSETS = ['./','./index.html','./app.css?v=20260907-logo','./app.js?v=20260907-autorefresh','./search.js','./question-bank.json','./manifest.json','./icons/icon.svg','./icons/developer-logo.webp'];
